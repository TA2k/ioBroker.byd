...
// Current app version - update when BYD releases new app
const APP_VERSION = '3.2.3';
const APP_INNER_VERSION = '323';

/**
 * Add dynamic app fields to a device fingerprint.
 * These fields change with app updates and should not be persisted.
 * @param {Object} fingerprint - Base device fingerprint
 * @returns {Object} Complete device config with app fields
 */
function addAppFields(fingerprint) {
    return {
        ...fingerprint,
        appVersion: APP_VERSION,
        appInnerVersion: APP_INNER_VERSION,
